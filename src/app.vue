...
import ToolbarCustom from "./public/components/toolbar-custom.component.vue";

export default {
  name: 'App',
  components: { ArticleList, LanguageSwitcher, FooterContent, UnavailableContent, SideMenu, ToolbarCustom },
  data() {
    return {
  ...
  <div class="w-full">
    <div>
      <pv-menubar class="sticky bg-primary">
        <template #start>
          <pv-button icon="pi pi-bars" label="CatchUp" text @click="toggleSidebar"></pv-button>
